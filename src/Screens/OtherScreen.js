    ...
    <SafeAreaView style={{height: windowHeight - 50}}>
          ...
          <View style={styles.header_icon}>
            <TouchableOpacity style={styles.header_Ticket}>
              <Material
                ...
                style={styles.header_iconTicket}
              />
            ...
            <TouchableOpacity style={styles.header_notification}>
              <Material
                name="bell-outline"
                style={styles.header_iconNotification}
              />
            </TouchableOpacity>
          </View>
        </View>
      ...
      <ScrollView
        ...
        <View style={styles.body}>
          ...
          {/* Support */}
          <Text style={{marginTop: 25, ...styles.body_titleHeading}}>
            Hỗ trợ
          </Text>
          <View
            style={{
            ...
            <TouchableOpacity style={styles.body_itemMain}>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Text style={styles.body_textMain}>Đánh giá đơn hàng</Text>
              </View>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Ionicons name="chatbox-outline" style={styles.body_iconMain} />
                <Text style={styles.body_textMain}>Đăng nhập ngay</Text>
              </View>
              <Material name="chevron-right" style={styles.body_iconMain} />
            </TouchableOpacity>
            <ModalLogin
